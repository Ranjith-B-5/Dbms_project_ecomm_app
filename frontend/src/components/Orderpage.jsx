...
function Orderpage()
{
    ...
    return(
		 ...
		 <div className="m-0 w-full h-screen bg-gray-100 r-64 pt-14 border-solid">
            ...
            {orderpdtdetails && <div className="bg-slate-800 text-white h-8 text-center w-24 ml-8">Order ID: {orderpdtdetails[0].oid}</div>}
            {orderpdtdetails &&<div className="border border-solid ml-8 mr-80 bg-gray-200 ">
                ...
                <div className="pr-6 py-2 text-xl flex flex-row justify-end "><text>Total Amount: </text>< text className="font-semibold" >Rs.{orderpdtdetails[0].totalamount}</text></div>
                </div>
                </div>}
